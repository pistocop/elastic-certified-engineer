...
## Notes
- (?) Problem: the [documentation](https://www.elastic.co/guide/en/elasticsearch/reference/current/docker.html#_prepare_the_environment) say certificate is under `es01:/usr/share/elasticsearch/config/certs/http_ca.crt .`

...
docker exec -u root 17_custom-cluster8x_es01_1 find /usr/share/elasticsearch/config/ -type d -exec chmod 750 \{\} \;;
docker exec -u root 17_custom-cluster8x_es01_1 find /usr/share/elasticsearch/config/ -type f -exec chmod 640 \{\} \;;
...
docker exec -u root 17_custom-cluster8x_es02_1 find /usr/share/elasticsearch/config/ -type d -exec chmod 750 \{\} \;;
docker exec -u root 17_custom-cluster8x_es02_1 find /usr/share/elasticsearch/config/ -type f -exec chmod 640 \{\} \;;
...
docker exec -u root 17_custom-cluster8x_es03_1 find /usr/share/elasticsearch/config/ -type d -exec chmod 750 \{\} \;;
docker exec -u root 17_custom-cluster8x_es03_1 find /usr/share/elasticsearch/config/ -type f -exec chmod 640 \{\} \;;

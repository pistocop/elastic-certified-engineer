...
docker exec -u root 17_custom-cluster8x_es02_1 chown -R root:root /usr/share/elasticsearch/config;
...
docker exec -u root 17_custom-cluster8x_es03_1 chown -R root:root /usr/share/elasticsearch/config;
